...
const OTP = () => {
  ...
  const render = () => {
    return otpArr.map((otp, index) => {
      return (<input className='border-2 w-16 h-16 p-1 m-1 border-purple-400 rounded-md outline-pink-400 text-pink-700 text-center' key={index} type="text" value={otp}
